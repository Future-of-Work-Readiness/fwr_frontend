...
import { useCompleteOnboardingMutation } from "@/hooks/useCareerMutations";
...
export default function OnboardingPage() {
  ...
  }, [completeOnboardingMutation.isSuccess, completeOnboardingMutation.isError, completeOnboardingMutation.error, router]);
  ...
  switch (step) {
    ...
    case "sector":
      return <SectorSelection onSelect={handleSectorSelect} onBack={() => setStep("intro")} />;
    case "field":
