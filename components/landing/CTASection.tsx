...
const CTASection = () => {
	return (
		<section className='py-20 lg:py-32 relative overflow-hidden'>
			...
			<div
				className='absolute bottom-0 right-1/4 w-80 h-80 bg-accent/20 rounded-full blur-[100px] animate-pulse-slow'
				...
				<div className='max-w-4xl mx-auto'>
					...
					<ScrollReveal className='flex justify-center mb-8'>
						<div className='relative'>
							...
							<div className='absolute -inset-3 bg-accent/20 rounded-3xl blur-xl -z-10 animate-pulse' />
						</div>
					</ScrollReveal>
